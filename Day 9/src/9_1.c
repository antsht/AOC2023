...
int main() {
    ...
    for (int i = 0; i < ROWS_COUNT; ++i) {
        records[i].prediction = calculate_next(records[i].data, COL_COUNT);
        sum += records[i].prediction;
    }
