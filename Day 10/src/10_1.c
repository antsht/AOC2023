...
map_node_t map[COLS_COUNT][ROWS_COUNT];
...
point_t make_move(point_t point_from) {
    ...
    if (map[point_from.row][point_from.col].m_up == 1 &&
        map[point_from.row - 1][point_from.col].visited == 0) {
        next_point.row = point_from.row - 1;
        next_point.col = point_from.col;
        map[next_point.row][next_point.col].visited = 1;
    } else if (map[point_from.row][point_from.col].m_down == 1 &&
               map[point_from.row + 1][point_from.col].visited == 0) {
        next_point.row = point_from.row + 1;
        next_point.col = point_from.col;
        map[next_point.row][next_point.col].visited = 1;
    } else if (map[point_from.row][point_from.col].m_right == 1 &&
               map[point_from.row][point_from.col + 1].visited == 0) {
        next_point.row = point_from.row;
        next_point.col = point_from.col + 1;
        map[next_point.row][next_point.col].visited = 1;
    } else if (map[point_from.row][point_from.col].m_left == 1 &&
               map[point_from.row][point_from.col - 1].visited == 0) {
        next_point.row = point_from.row;
        next_point.col = point_from.col - 1;
        map[next_point.row][next_point.col].visited = 1;
