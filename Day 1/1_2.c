            ...
            while(buffer[i] != '\0')
            {
                switch (buffer[i]) 
                {
                    case 'o':
                        ...
                        break;
                    case 't':
                        if (strncmp(&buffer[i], "two", 3) == 0) buffer[i] = '2';
                        else if (strncmp(&buffer[i], "three", 5) == 0) buffer[i] = '3';
                        break;
                    case 'f':
                        if (strncmp(&buffer[i], "four", 4) == 0) buffer[i] = '4';
                        else if (strncmp(&buffer[i], "five", 4) == 0) buffer[i] = '5';
                        break;
                    case 's':
                        if (strncmp(&buffer[i], "six", 3) == 0) buffer[i] = '6';
                        else if (strncmp(&buffer[i], "seven", 5) == 0) buffer[i] = '7';
                        break;
                    case 'e':
